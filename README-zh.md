...
| 方面 | 状态 |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.1`（2026-09-18 核验：双 typecheck 尺子 + 89 项测试 + self-contained/artifacts 门；peer 三段式 `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0`）。全族唯一已实跑 alpha.2 宿主冒烟的仓（2026-09-11）。 |
| Node | `^22.19.0 \|\| >=24.0.0` |
