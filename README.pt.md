...
| Superfície | Status |
|---|---|
| Harness | DeepSeek Harness `0.1.2-rc.1` (compatibilidade declarada para `0.1.2-rc.1`). Verificado em 2026-09-06 contra o checkout master do dsh-v0.1.3-alpha.1 (cadeia de portas completa + smoke de instalação de profile). |
| Node | `^22.19.0 \|\| >=24.0.0` |
