...
| Superfície | Status |
|---|---|
| Harness | DeepSeek Harness `0.1.2-alpha.3` (compatibilidade declarada para `0.1.2-alpha.3`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
