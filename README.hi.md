...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `0.1.2-rc.1` (`0.1.2-rc.1` के लिए घोषित संगतता)। 2026-09-06 को dsh-v0.1.3-alpha.1 master checkout के विरुद्ध सत्यापित (पूर्ण गेट श्रृंखला + profile इंस्टॉल smoke)। |
| Node | `^22.19.0 \|\| >=24.0.0` |
