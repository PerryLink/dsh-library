...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `0.1.2-alpha.3` (`0.1.2-alpha.3` के लिए घोषित संगतता) |
| Node | `^22.19.0 \|\| >=24.0.0` |
