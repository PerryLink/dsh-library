...
| Superficie | Estado |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-alpha.1` (compatibilidad declarada para `0.1.2-rc.1`). Verificado el 2026-09-09 contra el checkout master de dsh-v0.1.5-alpha.1 (cadena de puertas completa + smoke de instalación de profile). |
| Node | `^22.19.0 \|\| >=24.0.0` |
