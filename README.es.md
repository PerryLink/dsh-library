...
| Superficie | Estado |
|---|---|
| Harness | DeepSeek Harness `0.1.2-alpha.3` (compatibilidad declarada para `0.1.2-alpha.3`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
